...
const ExperienceCard: React.FC<ExperienceCardProps> = ({
  ...
  return (
    <CardContainer>
      ...
      <SectionTitle>{t('bandit.experience.tasks')}</SectionTitle>
      <DividerLine />
      <List>
      ...
      <SectionTitle>{t('bandit.experience.tools')}</SectionTitle>
      <DividerLine />
      <ToolsContainer>
      ...
      <SectionTitle>{t('bandit.experience.results')}</SectionTitle>
      <DividerLine />
      <List>
