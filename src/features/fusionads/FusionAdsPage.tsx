...
const FusionAdsPage: React.FC = () => {
  ...
  const currentExperienceData = frontendDevelopmentExperienceData[
    language
        ...
        <FusionAdsBanner>
          ...
          <BannerContent>
            <LeftContent>
              <LogoImage
                src={fusionAdsLogo}
                alt={t('fusionadsBanner.logoAlt', 'FusionAds.ai Logo')}
              />
            ...
            <RightContent>
              <img
                src={fusionAdsAppImage}
                alt={t('fusionadsBanner.appImageAlt', 'FusionAds Application Screenshot')}
              />
            </RightContent>
          </BannerContent>
        </FusionAdsBanner>
          ...
          {fusionProjectsData.length > 0 ? (
            ...
            <p>
              {language === 'en'
                ...
                : 'Próximamente se agregarán proyectos aquí.'}
            </p>
          )}
        </MasonryWrapper>
      </PageContainer>
