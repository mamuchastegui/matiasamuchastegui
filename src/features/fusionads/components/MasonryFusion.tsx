...
export const MasonryFusion: React.FC<MasonryProps> = ({
  data,
        ...
        item =>
          ...
          (item.title &&
            (item.title.es
              .toLowerCase()
              .replace(/\s+/g, '')
              .includes(initialSelectedProject.toLowerCase().replace(/\s+/g, '')) ||
              item.title.en
                .toLowerCase()
                .replace(/\s+/g, '')
                .includes(initialSelectedProject.toLowerCase().replace(/\s+/g, ''))))
  ...
  const transitions = useTransition(gridItems, {
    ...
    update: ({ x, y, width: w, height: h }: GridItem) => ({
      x,
      y,
      width: w,
      height: h,
            ...
            <div className="modal-content-wrapper" onClick={e => e.stopPropagation()}>
              ...
              <div className="modal-info-area">
                {selectedContent.title && (
                  <ModalInfoTitle>{selectedContent.title[language]}</ModalInfoTitle>
                )}
